...
We would expect to see both graphs of eq size (50% on each side) if the two are independent. They do not appear to be equal  .. shedding doubt on the idea of Independence.  
...
We now want to run a statistical test to see if the aides vaccine was seemingly effective. We state the null and alternative hypothesis for this test.

Our Null Hypothesis shall be:  

$H_0:$  There is no relationship between getting Aids and haven taken the  Aids vaccine.  

The Alternative Hypothesis is:  
$H_a:$ There is a relationship between getting Aids and having the vaccine. 
...
## Conclusions
There is no correlation in getting Aids and having a vaccine, because people that got a placebo were still placed higher in the bar graph, greater than those with a vaccine.
